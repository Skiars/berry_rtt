...
/* Macro: BE_USE_DEBUG_DUMP
 * default: 1
 **/
#define BE_USE_DEBUG_DUMP               0
 ...
 */
#define BE_EXPLICIT_ABORT               be_rtt_abort
#define BE_EXPLICIT_EXIT                be_rtt_exit
#define BE_EXPLICIT_MALLOC              rt_malloc
#define BE_EXPLICIT_FREE                rt_free
#define BE_EXPLICIT_REALLOC             rt_realloc

/* Macro: be_assert
 * Berry debug assertion. Only enabled when BE_DEBUG is active.
 * default: use the assert() function of the standard library.
 **/
#define be_assert(expr)                 rt_assert(expr)
